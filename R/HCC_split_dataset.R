#' Function of dividing spatial transcriptome data of hepatocellular carcinoma (HCC)
#'
#' @param data :Spatial Transcriptome Data of Hepatocellular Carcinoma (HCC)
#' @param seed :random seed
#'
#' @return :Contains a list of training sets, test sets and verification sets.
#' @export
#'
#' @examples DHMOC.HCC_split_dataset(data,seed)
